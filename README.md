...
Observer outputs must not become operational dependencies.
...
## Propagation Boundary Invariant
...
Failure visibility remains local unless separately proven at the relevant observation boundary.
...
An observable continuation-adjacent structure existed without explicit execution admission or declared operational legitimacy.

---

# Signal Routing and Propagation Boundaries

An experimental observer-side harmonization layer exists at:

`observatory_extensions/signal_routing/SIGNAL_ROUTING_AND_PROPAGATION_BOUNDARIES.md`

This layer:

- separates routing from validation
- separates observability from authority
...
# Current Observatory Areas

## Continuity Topology Mapping

Inspection of continuation survivability across distributed operational surfaces.
...
- continuity heatmaps
- distributed recovery visibility

---

## Failure Formation Locator (FFL)

Observer-only continuity degradation inspection framework.
...
It classifies bounded continuity degradation visibility under deterministic replay conditions.

---

## Signal Routing and Harmonization

Observer-side inspection layer for:

- routing compatibility
- propagation gating
- interface continuity
- local containment visibility
- recovery-before-optimization inspection
...
Additional conceptual expansion is intentionally secondary to:
...
The HACR Hybrid Observatory is not:
...
- a sovereign system
- a replacement for bind-local admissibility

The observatory remains observer-restricted.

All operational execution authority must remain external to the observatory.
