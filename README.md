...
- coordination burden
- distributed continuation surfaces
- semantic-density stabilization
- observer-local HOLD preservation

The observatory is diagnostic only.
...
!=
recoverable interruption realism

symbolic governability
!=
materially recoverable interruption capability

formal interruptibility
!=
practical executable interruption realism

recoverability
!=
preserved interruption realism
...
- Semantic Cooling Auditor
- Visual Authority Drift Harness
- Recursive Importance Drift Auditor
...
```bat
RUN_COOLING_STACK.bat
RUN_COOLING_REGRESSION.bat