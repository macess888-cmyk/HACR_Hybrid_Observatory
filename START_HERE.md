...
The HACR Hybrid Observatory is a deterministic, observer-only hostile-runtime interruption realism observatory.
...
The repository includes bounded runtime immune-system infrastructure focused on:
